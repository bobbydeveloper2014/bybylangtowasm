  ...
  framePtr = F;
    ...
    Label2: {
      ...
      Label3: {
        F.line = 129;
          Label4: while (true) {
          if (!(i_536870993 < n_p3)) break Label4;
            F.line = 50;
            F.filename = "digitsutils.nim";
            iHEX60gensym4_301990110 = i_536870993;
            F.line = 47;
            ...
            F.line = 131;
            F.filename = "iterators_1.nim";
            i_536870993 = addInt(i_536870993, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace__system_u2084(f_p0) {
  var result_33556518 = [[]];
    ...
    Label5: {
      ...
      colontmp__536870985 = (i_33556527 - 1);
      var res_536870987 = colontmp__536870985;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_536870987)) break Label7;
            j_33556562 = res_536870987;
...
function test__test_u33() {
  var F = {procname: "test.test", prev: framePtr, filename: "/Volumes/Data/Laptrinh/App/bybylangtowasm/test.nim", line: 0};
  framePtr = F;
    F.line = 17;
    F.filename = "test.nim";
...
function testtest__test_u32() {
  var F = {procname: "test.testtest", prev: framePtr, filename: "/Volumes/Data/Laptrinh/App/bybylangtowasm/test.nim", line: 0};
  framePtr = F;
    F.line = 13;
    F.filename = "test.nim";
    rawEcho([116,101,115,116,49,50,51,52]);
...
var F = {procname: "module test", prev: framePtr, filename: "/Volumes/Data/Laptrinh/App/bybylangtowasm/test.nim", line: 0};
framePtr = F;
F.line = 3;
F.filename = "test.nim";
...
test__test_u33();
F.line = 24;
var otest_536870946 = [8748199];
F.line = 25;
rawEcho(HEX24__systemZdollars_u14(otest_536870946[0]));
F.line = 26;
rawEcho([57,57,52,52,55,52,53]);
F.line = 27;
rawEcho([116,101,115,116,49,50,51,52]);
F.line = 28;
rawEcho([88,105,110,32,99,104,195,160,111]);
...
testtest__test_u32();
F.line = 30;
rawEcho(HEX24__systemZdollars_u14(addInt(1234567890, 987654321)));
F.line = 31;
rawEcho([57,57,48,48,48,48,49]);
F.line = 32;
rawEcho([53,56,53,57,54,51]);
F.line = 33;
rawEcho([57,50,48,49,56,57,55,49,56,57]);
F.line = 34;
rawEcho([57,57,49,49,49,49,49,49,49]);
F.line = 35;
rawEcho([57,56,56,56,56,56,56,57,48]);
F.line = 36;
rawEcho([57,57,57,57,57,57,57,57,57]);
F.line = 37;
rawEcho([51,48,48,48,48,48,48,48,48]);
F.line = 38;
rawEcho([45,51,50,55,55,55,55,55,55,56]);
F.line = 39;
rawEcho([51,48,53]);
framePtr = F.prev;
var F = {procname: "module test", prev: framePtr, filename: "/Volumes/Data/Laptrinh/App/bybylangtowasm/test.nim", line: 0};
